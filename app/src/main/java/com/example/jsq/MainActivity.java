...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    Button btn_0,btn_1,btn_2,btn_3,btn_4,btn_5,btn_6,
            ...
            btn_sub,btn_add,btn_equ,btn_point;
    EditText text;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_PandM = (Button) findViewById(R.id.btn_Change);
    ...
    public void onClick(View v) {
        ...
        switch(v.getId()){
            ...
            case R.id.btn_equ:
                ...
                {
                    Toast.makeText(MainActivity.this,"无法输出",Toast.LENGTH_SHORT).show();
                    text.setText(0);
                }
                if(str.charAt(str.length()-1)=='+'||str.charAt(str.length()-1)=='-'||str.charAt(str.length()-1)=='×'||str.charAt(str.length()-1)=='÷'){
                    Toast.makeText(MainActivity.this,"请将算式输入完全！",Toast.LENGTH_SHORT).show();
                    text.setText(str);
                }
                else {
                    ...
                    if (ero.equals("no error")) {
                        String r = getResult();
                        if (r.contains("Infinity")) {
                            Toast.makeText(MainActivity.this, "0不能被除！", Toast.LENGTH_SHORT).show();
                            text.setText("0");
                        } else {
                            text.setText(r);
                        }
            ...
            case R.id.btn_squ2:
                if(str.charAt(0)=='-'){
                    ...
                    x=Math.sqrt(x);
                    String x2=String.format("%.9f",x);//保留九位小数
